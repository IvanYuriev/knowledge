namespace CSharpAsync
{
    ...
    public static class AsyncCausalityTracer
    {
        ...
        internal static void TraceOperationCreation(object required, int id, string v1, int v2)
        {
    ...
    public struct AsyncTaskMethodBuilder<TResult>
    {
        ...
        internal readonly static Task<TResult> s_defaultResultTask = null; //AsyncTaskCache.CreateCacheableTask(default(TResult));
        ...
        internal TaskCompletionSource<TResult> _tcs;
        ...
        public void SetTcs(TaskCompletionSource<TResult> tcs)
        {
            _tcs = tcs;
        }
        /// <summary>
        ...
        where TStateMachine : IAsyncStateMachine
        {
            try
            {
                ...
                if (m_coreState.m_stateMachine == null)
                {
                    ...
                    m_coreState.PostBoxInitialization(stateMachine, runnerToInitialize, builtTask, _tcs);
                }
        ...
        public Task<TResult> Task
        {
            get
            {
                ...
                if (task == null) 
                { 
                    _tcs = new System.Threading.Tasks.TaskCompletionSource<TResult>();
                    m_task = task = _tcs.Task;
                    //m_task = task = new Task<TResult>(() => { return default(TResult); }); 
                }
                return task;
            }
        }
        ...
        private Task<TResult> GetTaskForResult(TResult result)
        {
            ...
            //return new Task<TResult>(() => { return result; });
            ...
            //         return (Task<TResult>)(task); // UnsafeCast avoids type check we know will succeed
            //     }
    ...
    internal struct AsyncMethodBuilderCore
    {
        ...
        public void SetStateMachine(IAsyncStateMachine stateMachine)
        {
            if (stateMachine == null) throw new ArgumentNullException("stateMachine");
            Contract.EndContractBlock();
            if (m_stateMachine != null) throw new InvalidOperationException("AsyncMethodBuilder_InstanceNotInitialized");
